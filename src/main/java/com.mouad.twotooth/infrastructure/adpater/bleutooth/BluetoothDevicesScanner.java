...
import main.java.com.mouad.twotooth.core.port.output.DeviceScannerPort;

import javax.bluetooth.*;
import java.util.HashSet;
import java.util.Set;

public class BluetoothDevicesScanner implements DeviceScannerPort, DiscoveryListener {
